...
import com.ikechi.studio.recyclingview.view.*;
...
public abstract class RecyclingAdapter {
    ...
    final void attachTo(RecyclingView view) { mAttachedView = view; }

    /** Called by RecyclingView only. */
    final void detach() { mAttachedView = null; }
    ...
    public abstract static class ViewHolder {
        ...
        final void    setPosition(int pos)           { mPosition = pos; }
        final void    setViewType(int vt)            { mViewType = vt; }
        final int     getViewType()                  { return mViewType; }
        final void    setPendingRemove(boolean flag) { mPendingRemove = flag; }
        final boolean isPendingRemove()              { return mPendingRemove; }
        final void    setPendingAdd(boolean flag)    { mPendingAdd = flag; }
        final boolean isPendingAdd()                 { return mPendingAdd; }
        final void    setPreLayoutLead(int lead)     { mPreLayoutLead = lead; }
        final int     getPreLayoutLead()             { return mPreLayoutLead; }
        final boolean hasPreLayoutLead() {
            return mPreLayoutLead != Integer.MIN_VALUE;
        }
        final void    clearPreLayoutLead()           { mPreLayoutLead = Integer.MIN_VALUE; }
    }
}
